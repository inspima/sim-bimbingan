...
class Tesis_proposal extends CI_Controller {
    ...
    public function index() {
        $data = array(
            ...
            'section' => 'backend/baa/magister/proposal/index',
            // DATA //
    ...
    public function cetak_undangan() {
        ...
        if ($hand == 'center19') {
            ...
            ob_end_clean();
            $page = 'backend/baa/magister/proposal/cetak_undangan';
            $size = 'legal';
            ...
            redirect('baa/magister/tesis/proposal/');
        }
    }
    ...
    public function cetak_penilaian() {
        ...
        if ($hand == 'center19') {
            ...
            //print_r($data['penguji_ketua']);die();
            ob_end_clean();
            $page = 'backend/baa/magister/proposal/cetak_penilaian';
            $size = 'legal';
            $this->pdf->setPaper($size, 'potrait');
    ...
    public function cetak_absensi() {
        ...
        if ($hand == 'center19') {
            ...
            //print_r($data['penguji_ketua']);die();
            ob_end_clean();
            $page = 'backend/baa/magister/proposal/cetak_absensi';
            $size = 'legal';
            $this->pdf->setPaper($size, 'potrait');
