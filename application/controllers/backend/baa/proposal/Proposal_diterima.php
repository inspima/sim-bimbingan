...
class Proposal_diterima extends CI_Controller {
    ...
    $this->load->model('backend/baa/proposal/proposal_diterima_model','proposal');
	//END MODEL
	}
	...
	public function index()
	{
        ...
        'subtitle'	=> 'Data Proposal (Diterima)',
        'section'	=> 'backend/baa/proposal/proposal_diterima',
        // DATA //
