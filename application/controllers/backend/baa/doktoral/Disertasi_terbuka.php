...
class Disertasi_terbuka extends CI_Controller {
    ...
    public function index() {
        $data = array(
            ...
            'section' => 'backend/baa/doktoral/terbuka/index',
            // DATA //
    ...
    public function cetak_undangan() {
        ...
        if ($hand == 'center19') {
            ...
            ob_end_clean();
            $page = 'backend/baa/doktoral/terbuka/cetak_undangan';
            $size = 'legal';
            ...
            redirect('baa/doktoral/disertasi/terbuka/');
        }
    }
    ...
    public function cetak_berita() {
        ...
        if ($hand == 'center19') {
            ...
            //print_r($data['penguji_ketua']);die();
            ob_end_clean();
            $page = 'backend/baa/doktoral/terbuka/cetak_berita';
            $size = 'legal';
            $this->pdf->setPaper($size, 'potrait');
    ...
    public function cetak_penilaian() {
        ...
        if ($hand == 'center19') {
            ...
            //print_r($data['penguji_ketua']);die();
            ob_end_clean();
            $page = 'backend/baa/doktoral/terbuka/cetak_penilaian';
            $size = 'legal';
            $this->pdf->setPaper($size, 'potrait');
    ...
    public function cetak_absensi() {
        ...
        if ($hand == 'center19') {
            ...
            //print_r($data['penguji_ketua']);die();
            ob_end_clean();
            $page = 'backend/baa/doktoral/terbuka/cetak_absensi';
            $size = 'legal';
            $this->pdf->setPaper($size, 'potrait');
