	...
	class Disertasi_kelayakan extends CI_Controller
	{
		...
		public function index()
		{
			$data = array(
				...
				'section' => 'backend/baa/doktoral/kelayakan/index',
				// DATA //
		...
		public function cetak_undangan()
		{
			...
			if ($hand == 'center19') {
				...
				ob_end_clean();
				$page = 'backend/baa/doktoral/kelayakan/cetak_undangan';
				$size = 'legal';
		...
		public function cetak_berita()
		{
			...
			if ($hand == 'center19') {
				...
				//print_r($data['penguji_ketua']);die();
				ob_end_clean();
				$page = 'backend/baa/doktoral/kelayakan/cetak_berita';
				$size = 'legal';
				$this->pdf->setPaper($size, 'potrait');
				...
				$this->session->set_flashdata('msg-title', 'alert-danger');
				$this->session->set_flashdata('msg', 'Terjadi Kesalahan');
				redirect('baa/doktoral/disertasi/kelayakan/');
			}
		}
		...
		public function cetak_penilaian()
		{
			...
			if ($hand == 'center19') {
				...
				//print_r($data['penguji_ketua']);die();
				ob_end_clean();
				$page = 'backend/baa/doktoral/kelayakan/cetak_penilaian';
				$size = 'legal';
				$this->pdf->setPaper($size, 'potrait');
		...
		public function cetak_absensi()
		{
			...
			if ($hand == 'center19') {
				...
				//print_r($data['penguji_ketua']);die();
				ob_end_clean();
				$page = 'backend/baa/doktoral/kelayakan/cetak_absensi';
				$size = 'legal';
				$this->pdf->setPaper($size, 'potrait');
