...
class Ujian extends CI_Controller {
    ...
    public function index() {
        ...
        $data = array(
            ...
            'title' => 'Tesis - Ujian',
            'subtitle' => 'Data',
            'section' => 'backend/prodi/tesis/ujian/index',
            // DATA //
    ...
    public function approve() {
        ...
        //redirect('prodi/tesis/ujian/index/'.$id_prodi);
        redirect('prodi/tesis/ujian');
    }
    ...
    public function reject() {
        ...
        //redirect('prodi/tesis/ujian'.$id_prodi);
        redirect('prodi/tesis/ujian');
    }
    ...
    public function nilai_ujian() {
        ...
        $data = array(
            ...
            'section' => 'backend/prodi/tesis/ujian/nilai_ujian',
            'use_back' => true,
            //'back_link' => 'prodi/tesis/ujian/index/'.$id_prodi,
            'back_link' => 'prodi/tesis/ujian',
            // DATA //
            'id_ujian' => $id_ujian,
            'tesis' => $this->tesis->detail($id_tesis),
    ...
    public function nilai_ujian_save() {
        ...
        if ($hand == 'center19') {
            ...
            redirect('prodi/tesis/ujian/nilai_ujian/' . $id_tesis .'/'.$id_ujian);
