...
class Tesis_ujian extends CI_Controller {
    ...
    public function cetak_sk_tesis_ulang() {
        //$hand = $this->input->post('hand', TRUE);
        $hand = $this->input->post('hand', true);
        if ($hand == 'center19') {
            $id_tesis = $this->input->post('id_tesis', true);
            ...
            $link_dokumen = base_url() . 'document/lihat_tesis?doc=' . bin2hex($this->encryption->create_key(32)) . '$' . $id_tesis . '$' . DOKUMEN_SK_UJIAN_TESIS_ULANG . '$' . TAHAPAN_TESIS_UJIAN_STR . '$' . TAHAPAN_TESIS_UJIAN;
            $link_dokumen_cetak = base_url() . 'document/cetak_tesis?doc=' . bin2hex($this->encryption->create_key(32)) . '$' . $id_tesis . '$' . DOKUMEN_SK_UJIAN_TESIS_ULANG . '$' . TAHAPAN_TESIS_UJIAN_STR . '$' . TAHAPAN_TESIS_UJIAN;
            // QR
            $qr_image_dokumen_name = $this->qrcode->generateQrImageName('Dokumen SK Tesis', 'Ujian Tesis', $tesis->nim, $tgl_surat_ymd);
            $qr_content = 'Buka dokumen ' . $link_dokumen; //data yang akan di jadikan QR CODE
            $this->qrcode->generateQr($qr_image_dokumen_name, $qr_content);
            // DOKUMEN
            $data_dokumen = [
                'kode' => $this->dokumen->generate_kode(DOKUMEN_SK_UJIAN_TESIS_ULANG, 'tesis_ujian', $tesis->nim, ''),
    ...
    public function cetak_berita_ulang() {
        ...
        if ($hand == 'center19') {
            ...
            $link_dokumen = base_url() . 'document/lihat_tesis?doc=' . bin2hex($this->encryption->create_key(32)) . '$' . $id_tesis . '$' . DOKUMEN_BERITA_ACARA_UJIAN_TESIS_ULANG . '$' . TAHAPAN_TESIS_UJIAN_STR . '$' . TAHAPAN_TESIS_UJIAN;
            $link_dokumen_cetak = base_url() . 'document/cetak_tesis?doc=' . bin2hex($this->encryption->create_key(32)) . '$' . $id_tesis . '$' . DOKUMEN_BERITA_ACARA_UJIAN_TESIS_ULANG . '$' . TAHAPAN_TESIS_UJIAN_STR . '$' . TAHAPAN_TESIS_UJIAN;
            // QR
            $qr_image_dokumen_name = $this->qrcode->generateQrImageName('Dokumen Berita Acara', 'Tesis', $tesis->nim, $jadwal->tanggal);
            $qr_content = 'Buka dokumen ' . $link_dokumen; //data yang akan di jadikan QR CODE
            $this->qrcode->generateQr($qr_image_dokumen_name, $qr_content);
            // DOKUMEN
            $data_dokumen = [
                'kode' => $this->dokumen->generate_kode(DOKUMEN_BERITA_ACARA_UJIAN_TESIS_ULANG, 'tesis_ujian', $tesis->nim, $jadwal->tanggal),
    ...
    public function cetak_daftar_hadir_ulang()
    {
        ...
        if ($hand == 'center19') {
            ...
            // DOKUMEN
            $data_dokumen = [
                'kode' => $this->dokumen->generate_kode(DOKUMEN_DAFTAR_HADIR_UJIAN_TESIS_ULANG, 'tesis_ujian', $tesis->nim, ''),
    ...
    public function cetak_undangan_ulang()
    {
        ...
        if ($hand == 'center19') {
            ...
            // DOKUMEN
            $data_dokumen = [
                'kode' => $this->dokumen->generate_kode(DOKUMEN_UNDANGAN_UJIAN_TESIS_ULANG, 'tesis_ujian', $tesis->nim, ''),
