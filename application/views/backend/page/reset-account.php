	...
	<div class="col-md-4">
		<div class="box box-default box-solid">
			<div class="box-header with-border">
				<h3 class="box-title text-shadow">Reset Akun Mahasiswa</h3>
			</div>
			<?php echo form_open('auth/reset-account') ?>
			<div class="box-body">
				...
				<div class="form-group">
					<label>Email <span class="text-info">(dimasukkan saat mendaftar)</span></label>
					<input type="email" name="email" placeholder="email@mhs.unair.ac.id" class="form-control" required>
				</div>
				<div class="form-group">
					<label>No HP/Whatsapp <span class="text-info">(dimasukkan saat mendaftar)</span></label>
