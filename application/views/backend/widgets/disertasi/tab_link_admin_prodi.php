<div class="btn-group">
	...
	<a class="<?= ($this->uri->segment(4) == 'mkpkk') ? 'btn btn-default' : 'btn bg-blue'; ?>" href="<?php echo base_url() ?>prodi/doktoral/disertasi/mkpkk">MKPKK</a>
	<a class="<?= ($this->uri->segment(4) == 'proposal') ? 'btn btn-default' : 'btn bg-green'; ?>" href="<?php echo base_url() ?>prodi/doktoral/disertasi/proposal">Ujian Proposal</a>
	<a class="<?= ($this->uri->segment(4) == 'mkpd') ? 'btn btn-default' : 'btn bg-purple'; ?>" href="<?php echo base_url() ?>prodi/doktoral/disertasi/mkpd">MKPD</a>
	<a class="<?= ($this->uri->segment(4) == 'kelayakan') ? 'btn btn-default' : 'btn bg-maroon'; ?>" href="<?php echo base_url() ?>prodi/doktoral/disertasi/kelayakan">Ujian Kelayakan</a>
