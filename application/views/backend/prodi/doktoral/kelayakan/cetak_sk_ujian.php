...
<table border="0" style="width:100%">
	...
	<tr>
		...
		<td style="width: 2%">:</td>
		<td style="width: 75%">
			<b>KEPUTUSAN DEKAN TENTANG PENGUJI UJIAN KELAYAKAN PROGRAM <?= strtoupper($this->setting->get_value('universitas_prodi_s3_txt')) ?> </b>
		</td>
	</tr>
	<tr>
