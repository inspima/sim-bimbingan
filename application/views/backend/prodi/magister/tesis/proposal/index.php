                                                    ...
                                                    <?php echo formtext('hidden', 'id_tesis', $list['id_tesis'], 'required') ?>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            ?>
                                                                ...
                                                                <input type="text" name="no_surat" class="form-control" style="width: 100%" value="<?= $no_surat; ?>" required placeholder="Nomor SK Dekan">
                                                                <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy"  style="width: 100%" >
                                                                    <input type="text" name="tgl_surat" class="form-control" value="<?= $tgl_surat; ?>" required placeholder="Tanggal SK Dekan">
                                                                    <div class="input-group-addon">
                                                                        <span class="glyphicon glyphicon-th"></span>
                                                                    </div>
                                                                </div>
