                    ...
                    <table border="0" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td style="width:80%;vertical-align: text-top" colspan="2">
                                ...
                                <p>Sehubungan dengan akan dilaksanakannya Ujian Proposal Mahasiswa Program Magister Program Studi S2 <?= ucwords(strtolower($tesis->nm_prodi));?> Fakultas Hukum Universitas Airlangga :</p>
                                <table border="0" style="width:100%">
                                    <tr>
                                        <td style="width:8%"></td>
                                    ...
                                    <tr>
                                        <td style="width:8%"></td>
                                        <td style="width:27%">Dosen Pembimbing Utama</td>
                                        <td style="width:3%">:</td>
                                        <td style="width:60%"><?= $tesis->nama_pembimbing_satu ?><td>
                                    </tr>
                                    <tr>
                                        <td style="width:8%"></td>
                                        <td style="width:27%">Dosen Pembimbing Kedua</td>
                                        <td style="width:3%">:</td>
