                        ...
                        foreach ($tesis as $list) {
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <?php
                                    echo "<hr>";
                                    echo "<strong>Ujian Ulang</strong>";
                                    $ujian_ulang = $this->tesis->read_jadwal_ujian_ulang($list['id_tesis'], UJIAN_TESIS_UJIAN);
                                    if ($ujian_ulang) {
                                ...
                                <td class="text-center">
                                    ...
                                    if ($ujian_ulang) {
                                        if ($list['status_tesis'] >= STATUS_TESIS_UJIAN) {
                                            ...
                                            $data_dokumen = [
                                                'tipe' => DOKUMEN_SK_UJIAN_TESIS_ULANG,
                                                'jenis' => DOKUMEN_JENIS_TESIS_UJIAN_STR,
                                                'identitas' => $list['nim'],
                                            ];
                                            $dokumen = $this->dokumen->detail_by_data($data_dokumen);
                                            ...
                                            ?>
                                            <br><br>
                                            <button type="button" class="btn btn-danger col-sm-12" data-toggle="modal" data-target="#myModalSKTesisUlang<?= $list['id_tesis']?>">
                                                <i class="fa fa-file"></i> SK Ujian
                                            </button>
                                            <br><br>
                                            <div class="modal fade" id="myModalSKTesisUlang<?= $list['id_tesis']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <?php $attributes = array('target' => '_blank'); ?>
                                                        <?php echo form_open('prodi/magister/tesis/ujian/cetak_sk_tesis_ulang', $attributes) ?>
                                                        <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                                                        <?php echo formtext('hidden', 'id_tesis', $list['id_tesis'], 'required') ?>
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            ...
                                            <?php
                                            $data_dokumen_berita = [
                                                'tipe' => DOKUMEN_BERITA_ACARA_UJIAN_TESIS_ULANG,
                                                'jenis' => DOKUMEN_JENIS_TESIS_UJIAN_STR,
                                                'identitas' => $list['nim'],
                                            ];
                                            $dokumen_berita = $this->dokumen->detail_by_data($data_dokumen_berita);
                                            ...
                                            ?>
                                            <button type="button" class="btn btn-danger col-sm-12" data-toggle="modal" data-target="#myModalBeritaAcaraUlang<?= $list['id_tesis']?>">
                                                <i class="fa fa-file"></i> Berita Acara
                                            </button>
                                            <br><br>
                                            <div class="modal fade" id="myModalBeritaAcaraUlang<?= $list['id_tesis']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        
                                                        <?php $attributes = array('target' => '_blank'); ?>
                                                        <?php echo form_open('prodi/magister/tesis/ujian/cetak_berita_ulang', $attributes) ?>
                                                        <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                                                        <?php echo formtext('hidden', 'id_tesis', $list['id_tesis'], 'required') ?>
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            ...
                                            <?php
                                            $data_dokumen_undangan = [
                                                'tipe' => DOKUMEN_UNDANGAN_UJIAN_TESIS_ULANG,
                                                'jenis' => DOKUMEN_JENIS_TESIS_UJIAN_STR,
                                                'identitas' => $list['nim'],
                                            ];
                                            $dokumen_undangan = $this->dokumen->detail_by_data($data_dokumen_undangan);
                                            ...
                                            ?>
                                            <button type="button" class="btn btn-danger col-sm-12" data-toggle="modal" data-target="#myModalUndanganUlang<?= $list['id_tesis']?>">
                                                <i class="fa fa-file"></i> Undangan
                                            </button>
                                            <br><br>
                                            <div class="modal fade" id="myModalUndanganUlang<?= $list['id_tesis']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        
                                                        <?php $attributes = array('target' => '_blank'); ?>
                                                        <?php echo form_open('prodi/magister/tesis/ujian/cetak_undangan_ulang', $attributes) ?>
                                                        <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                                                        <?php echo formtext('hidden', 'id_tesis', $list['id_tesis'], 'required') ?>
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            ...
                                            <?php
                                            $data_dokumen_presensi = [
                                                'tipe' => DOKUMEN_DAFTAR_HADIR_UJIAN_TESIS_ULANG,
                                                'jenis' => DOKUMEN_JENIS_TESIS_UJIAN_STR,
                                                'identitas' => $list['nim'],
                                            ];
                                            $dokumen_presensi = $this->dokumen->detail_by_data($data_dokumen_presensi);
                                            ...
                                            ?>
                                            <button type="button" class="btn btn-danger col-sm-12" data-toggle="modal" data-target="#myModalDaftarHadirUlang<?= $list['id_tesis']?>">
                                                <i class="fa fa-file"></i> Daftar Hadir
                                            </button>
                                            <br><br>
                                            <div class="modal fade" id="myModalDaftarHadirUlang<?= $list['id_tesis']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        
                                                        <?php $attributes = array('target' => '_blank'); ?>
                                                        <?php echo form_open('prodi/magister/tesis/ujian/cetak_daftar_hadir_ulang', $attributes) ?>
                                                        <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                                                        <?php echo formtext('hidden', 'id_tesis', $list['id_tesis'], 'required') ?>
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
