<div class="row">
    ...
    <div class="col-md-6">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <?php echo form_open('dashboardb/master/gelombang/save');?>
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <?php echo formtext('text', 'gelombang', '', 'required') ?>
                </div>
                <div class="form-group">
                    <label>No SK</label>
                    <?php echo formtext('text', 'no_sk', '', 'required') ?>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" name="tgl_sk" class="form-control pull-right" id="datepicker" data-date-format="dd/mm/yyyy">
                    </div>
                </div>
            </div>
            <!-- /.box-body -->
