<div class="row">
    ...
    <div class="col-md-6">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <?php echo form_open('dashboardb/master/mahasiswa/aktifkan_save');?>
            <div class="box-body">
                <div class="form-group">
                    <label>NIM</label>
                    <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                    <?php echo formtext_angka('hidden', 'id_mahasiswa', $mahasiswa->id_mahasiswa, 'required') ?>
                    <?php echo formtext_angka('text', 'nim', $mahasiswa->nim, 'readonly') ?>
                </div>
                <div class="form-group">
                    <label>Nama</label>
                    <?php echo formtext('text', 'nama', $mahasiswa->nama, 'readonly') ?>
                </div>
                <div class="form-group">
                    <label>Alamat</label>
                ...
                <div class="form-group">
                    <label>Telp</label>
                    <?php echo formtext('text', 'telp', '', 'required') ?>
                </div>
                <div class="form-group">
                    <label>Email</label>
