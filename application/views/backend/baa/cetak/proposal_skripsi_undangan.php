...
<table border="0" style="width:100%">
    ...
    <tr>
    	...
    	<table border="0" style="width:100%">
		    <tr>
		      ...
		      <td style="width:84%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/UN3.1.3/PPd/<?php echo date("Y");?></td>
		    </tr>
		    <tr>
    ...
    <tr>
    	...
    	<table border="0" style="width:100%">
		    ...
		    <tr>
		   		<td align="left"><?=$proposal->telp?></td>
		    </tr>
		</table> 
		<br>
		</td>
    ...
    <tr>
    	...
    	<table border="0" style="width:100%">
		    <tr>
		    	...
		    	<td style="width:40%" align="left">a.n. Dekan</td>
		    </tr>
		    <tr>
		    	<td align="left"></td>
		    	<td align="left">Wakil Dekan I,</td>
		    </tr>
		    <tr>
		    	<td align="left"></td>
		    ...
		    <tr>
		    	<td align="left"></td>
		    	<td align="left"><?=$wadek1->nama_dosen?></td>
		    </tr>
		    <tr>
		    	<td align="left"></td>
		    	<td align="left"><?='NIP. '.$wadek1->nip?></td>
		    </tr>
		</table> <br>
		</td>
    </tr>
