...
<table border="0" style="width:100%">
    ...
    <tr>
    	...
    	<table border="0" style="width:100%">
		    <tr>
			  <td style="width:15%" align="left">Berdasarkan Surat Keputusan Dekan Fakultas Hukum Universitas Airlangga tanggal <?php echo $gelombang->tgl_sk?> Nomor : <?php echo $gelombang->no_sk?> tentang Penguji Skripsi Semester <?php echo $gelombang->semester?>, maka pada hari <b><?php echo hari($skripsi->tanggal)?></b> tanggal <b><?php echo woday_toindo($skripsi->tanggal)?></b> pukul <?=substr($skripsi->jam,0,5);?> WIB di <?=$skripsi->ruang.' '.$skripsi->gedung?><br>
