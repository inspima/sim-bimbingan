...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="box-header with-border">
            ...
            <div class="pull-right">
                <a class="btn btn-xs btn-warning" href="<?= base_url()?>dashboardb/thesis/thesis"><i class="fa fa-arrow-left"></i> Kembali</a>
            </div>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
            <div class="box-body">
                <div class="form-group">
                    ...
                    <?php echo formtext('hidden', 'id_skripsi', $thesis->id_skripsi, 'required') ?>
                    <input type="text" name="nim" class="form-control" value="<?php echo $thesis->nim?>" readonly>
                </div>
                <div class="form-group">
                    <label>Nama</label>
                    <input type="text" name="nama" class="form-control" value="<?php echo $thesis->nama?>" readonly>
                </div>
                <div class="form-group">
                    <label>Judul</label>
                    <?php 
                            $judul = $this->thesis->read_judul($thesis->id_skripsi);
                            ?>
    ...
    <div class="col-md-8">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <?php echo form_open('dashboardb/thesis/thesis/ujian_save');?>
            <div class="box-body">
    ...
    <div class="col-md-8">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <?php echo form_open('dashboardb/thesis/thesis/penguji_save');?>
            <div class="box-body table-responsive">
                ...
                <?php 
                $ketua = $this->thesis->read_pengujiketua($id_ujian);
                if($ketua)
                {
                    echo '';
                }
        ...
        <?php echo form_close()?>                
                ...
                <table class="table table-bordered">
                    ...
                    <?php
                    $penguji = $this->thesis->read_penguji($ujian->id_ujian);
                    ...
                    <tr>
                        ...
                        {
                        ?>
                        <?php echo form_open('dashboardb/thesis/thesis/penguji_update_statustim')?>
                        <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                        <?php echo formtext('hidden', 'id_skripsi', $thesis->id_skripsi, 'required') ?>
                        <?php echo formtext('hidden', 'id_ujian', $id_ujian, 'required') ?>
                        ...
                        <td>
                        <?php echo form_open('dashboardb/thesis/thesis/penguji_delete')?>
                        <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                        <?php echo formtext('hidden', 'id_skripsi', $thesis->id_skripsi, 'required') ?>
                        <?php echo formtext('hidden', 'id_ujian', $id_ujian, 'required') ?>
                        <?php echo formtext('hidden', 'id_penguji', $listpenguji['id_penguji'], 'required') ?>
