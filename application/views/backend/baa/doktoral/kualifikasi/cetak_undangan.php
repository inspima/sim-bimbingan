                    ...
                    <table border="0" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td style="width:80%;vertical-align: text-top" colspan="2">
                                ...
                                <p>Sehubungan dengan akan dilaksanakannya Ujian Kualifikasi Mahasiswa Program Doktor Program Studi Ilmu Hukum Fakultas Hukum Universitas Airlangga :</p>
                                <table border="0" style="width:100%">
                                    <tr>
                                        <td style="width:8%"></td>
                                    ...
                                    <tr>
                                        <td style="width:8%"></td>
                                        <td style="width:27%">Penasehat Akademik</td>
                                        <td style="width:3%">:</td>
                                        <td style="width:60%"><td>
                                    </tr>
                                </table>
                                <p>Ujian Kualifikasi dilaksanakan pada :</p>
                                <table border="0" style="width:100%">
                                    <tr>
                                        <td style="width:8%"></td>
                                ...
                                <p>Maka dengan ini mohon kesediaan Saudara untuk menjadi Penguji pada Ujian Kualifikasi tersebut.</p>
