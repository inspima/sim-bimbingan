        ...
        <table border="0" style="width:100%">
            ...
            <tr>
                <td>
                    <table border="0" style="width:100%">
                        <tr>
                            <td align="center"><h3 style="margin: 5px"><b>PENILAIAN UJIAN AKHIR DISERTASI TAHAP I <br/>(UJIAN TERTUTUP)</b></h3></td>
                        </tr>
                    </table> 
                </td>
            </tr>
                ...
                <td>
                    <table border="0" class="padded" style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td style="width: 3%">:</td>
                            <td style="width: 77%">Ujian Proposal Mahasiswa <?= $disertasi->nama ?> (<?= $disertasi->nim ?>)</td>
                        </tr>
                    </table> 
                </td>
            </tr>
