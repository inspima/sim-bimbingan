        ...
        <div class="box">
            ...
            <div class="box-body table-responsive">
                <div class="btn-group">
                    ...
                    <a class="btn btn-default" href="<?php echo base_url() ?>sarjanah/skripsi/pengajuan">Pengajuan</a>
                    ...
                    <tbody>
                        ...
                        foreach ($skripsi as $list) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $judul = $this->skripsi_pengajuan->read_judul($list['id_skripsi']);
                                    echo $judul->judul;
                                    ?>
                                </td>                            
                                ...
                                <td>
                                    <?php
                                    $pembimbing = $this->skripsi_pengajuan->read_pembimbing($list['id_skripsi']);
