        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="btn-group">
                    ...
                    <a class="btn btn-default" href="<?php echo base_url() ?>sarjanah/proposal/diterima">Diterima</a>
                        ...
                        foreach ($proposal as $list) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if ($ujian) {
                                        $jumlah_penguji = $this->proposal_diterima->count_penguji($list['id_skripsi']);
                                        if ($jumlah_penguji < '3') {
