                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    if ($list['status_proposal'] >= 1) {
                                        ...
                                        <?php echo form_open('baa/magister/tesis/proposal/cetak_undangan', $attributes) ?>
                                        ...
                                        <!-- Berita Acara -->
                                        <?php $attributes = array('target' => '_blank'); ?>
                                        <?php echo form_open('baa/magister/tesis/proposal/cetak_berita', $attributes) ?>
                                        <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                                        <?php echo formtext('hidden', 'id_tesis', $list['id_tesis'], 'required') ?>
                                        ...
                                        <!-- Penilaian -->
                                        <?php $attributes = array('target' => '_blank'); ?>
                                        <?php echo form_open('baa/magister/tesis/proposal/cetak_penilaian', $attributes) ?>
                                        <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                                        <?php echo formtext('hidden', 'id_tesis', $list['id_tesis'], 'required') ?>
                                        ...
                                        <!-- Daftar Hadir -->
                                        <?php $attributes = array('target' => '_blank'); ?>
                                        <?php echo form_open('baa/magister/tesis/proposal/cetak_absensi', $attributes) ?>
                                        <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                                        <?php echo formtext('hidden', 'id_tesis', $list['id_tesis'], 'required') ?>
