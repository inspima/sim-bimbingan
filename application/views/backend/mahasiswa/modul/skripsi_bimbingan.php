...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="box box-primary">
			...
			<!-- /.box-header -->
			<!-- form start -->
			<?php echo form_open('dashboardm/modul/skripsi/bimbingan_save', ['enctype' => 'multipart/form-data']); ?>
			<div class="box-body">
				<div class="form-group">
					<label>Tanggal</label>
					<?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
				...
				<div class="form-group">
					<label>Bukti Revisi</label>
					<input type="file" name="file" value="" class="form-control" required>
					<span class="label bg-primary">Hanya diperbolehan (PDF,JPG,PNG)</span>
				</div>
				<div class="form-group">
