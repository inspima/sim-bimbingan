...
<div class="callout callout-info">
    <h4>Syarat</h4>
    <p>Daftar Ujian Tertutup, upload naskah perbaikan Ujian Kelayakan</p>
</div>
<div class="row">
    <!-- left column -->
    <div class="col-md-6">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open_multipart('mahasiswa/disertasi/tertutup/save'); ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label>Upload Naskah perbaikan Ujian Kelayakan <br/>(format file .pdf maks <?= MAX_SIZE_FILE_UPLOAD_DESCRIPTION ?>)</label>
                    <input type="file" name="berkas_tertutup" class="form-control" required>
                </div>
            </div>
            <!-- /.box-body -->
