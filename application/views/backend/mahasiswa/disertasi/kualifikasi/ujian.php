    ...
    <div class="col-md-6">
        ...
        <div class="box-header with-border">
            ...
            <div class="pull-right">
                <a class="btn btn-xs btn-warning" href="<?= base_url()?>dashboardm/modul/proposal"><i class="fa fa-arrow-left"></i> Kembali</a>
            </div>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
