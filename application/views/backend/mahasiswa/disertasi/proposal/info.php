    ...
    <div class="col-md-6">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
                <?php $this->view('backend/widgets/disertasi/list_promotor_kopromotor', ['disertasi' => $disertasi, 'action' => 'proposal']); ?>
            </div>
        </div>
        <!-- /.box -->
    </div>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="form-group">
                    <p>
                        <?php
                        echo $this->disertasi->get_status_ujian($disertasi->status_ujian_proposal, UJIAN_DISERTASI_PROPOSAL);
                        ?>
                    </p>
                </div>
            </div>
