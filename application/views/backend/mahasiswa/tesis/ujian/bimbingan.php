...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open_multipart('mahasiswa/tesis/ujian/bimbingan_save');?>
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>File Bimbingan Ujian Tesis<br/>(format file .pdf maks 2MB)</label>
                        <input type="file" name="berkas_bimbingan_tesis" class="form-control" >
                    </div>
                </div>
                <!-- /.box-body -->
                            ...
                            foreach ($bimbingan as $bt) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                            <a href="<?= base_url() ?>mahasiswa/tesis/ujian/delete_bimbingan/<?= $bt['id_tesis'] ?>/<?= $bt['id_bimbingan_tesis'] ?>" onclick="return confirm('Apakah anda yakin ?')" class="btn bg-red"><i class="fa fa-trash"></i> Hapus</a>
                                        <?php
                                        }
                                        ?>
                                    </td>
