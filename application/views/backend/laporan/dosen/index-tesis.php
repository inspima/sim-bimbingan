								...
								<td class="text-center">
									<?php
										if ($laporan['pembimbing_utama'] > 0) {
											?>
											<a href="<?=base_url()?>laporan/dosen/tesis/detail/<?=$laporan['nip']?>?tipe=pembimbing_utama" class="btn btn-xs btn-primary"><b><?= $laporan['pembimbing_utama'] ?></b></a>
											<?php
										} else {
											?>
								...
								<td class="text-center">
									<?php
										if ($laporan['pembimbing_anggota'] > 0) {
											?>
											<a href="<?=base_url()?>laporan/dosen/tesis/detail/<?=$laporan['nip']?>?tipe=pembimbing_anggota" class="btn btn-xs btn-primary"><b><?= $laporan['pembimbing_anggota'] ?></b></a>
											<?php
										} else {
											?>
								...
								<td class="text-center">
									<?php
										if ($laporan['penguji_utama'] > 0) {
											?>
											<a href="<?=base_url()?>laporan/dosen/tesis/detail/<?=$laporan['nip']?>?tipe=penguji_utama" class="btn btn-xs btn-primary"><b><?= $laporan['penguji_utama'] ?></b></a>
											<?php
										} else {
											?>
								...
								<td class="text-center">
									<?php
										if ($laporan['penguji_anggota'] > 0) {
											?>
											<a href="<?=base_url()?>laporan/dosen/tesis/detail/<?=$laporan['nip']?>?tipe=penguji_anggota" class="btn btn-xs btn-primary"><b><?= $laporan['penguji_anggota'] ?></b></a>
											<?php
										} else {
											?>
