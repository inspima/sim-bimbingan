...
<?php endif; ?>
<div class="btn-group">
    <a class="<?= ($this->uri->segment(4) == 'pengajuan_baru' OR $this->uri->segment(4) == '') ? 'btn btn-default' : 'btn bg-purple'; ?>" href="<?php echo base_url() ?>dosen/tesis/proposal/pengajuan_baru">Pengajuan Baru</a>
    <a class="<?= ($this->uri->segment(4) == 'penjadwalan' OR $this->uri->segment(4) == '') ? 'btn btn-default' : 'btn bg-aqua'; ?>" href="<?php echo base_url() ?>dosen/tesis/proposal/penjadwalan">Belum Disetting</a>
    <a class="<?= ($this->uri->segment(4) == 'penjadwalan_sudah') ? 'btn btn-default' : 'btn bg-yellow'; ?>" href="<?php echo base_url() ?>dosen/tesis/proposal/penjadwalan_sudah">Sudah Disetting</a>
    <a class="<?= ($this->uri->segment(4) == 'penjadwalan_selesai_proposal') ? 'btn btn-default' : 'btn bg-green'; ?>" href="<?php echo base_url() ?>dosen/tesis/proposal/penjadwalan_selesai_proposal">Selesai</a>
</div>
