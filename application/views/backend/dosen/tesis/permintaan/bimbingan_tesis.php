                            ...
                            foreach ($bimbingan as $bt) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if($bt['file'] != '') {
                                        ?>
                                            <a href="<?php echo base_url() ?>assets/upload/mahasiswa/tesis/ujian/bimbingan/<?php echo $bt['file'] ?>" target="_blank"><img src="<?php echo base_url() ?>assets/img/pdf.png" width="20px" height="auto"></a>
                                        <?php 
                                        }
                                        ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        if($tesis->nip_pembimbing_satu == $this->session_data['username']){
                                            ...
                                            ?>
                                                <a class="btn btn-xs btn-success"> Disetujui Pembimbing Utama</a>
                                                <a href="<?= base_url() ?>dosen/tesis/permintaan/batal_bimbingan/<?= $bt['id_tesis'] ?>/<?= $bt['id_bimbingan_tesis'] ?>/1/<?= UJIAN_TESIS_UJIAN ?>" onclick="return confirm('Apakah anda yakin ?')" class="btn btn-xs btn-danger"> Batal</a>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <a href="<?= base_url() ?>dosen/tesis/permintaan/approve_bimbingan/<?= $bt['id_tesis'] ?>/<?= $bt['id_bimbingan_tesis'] ?>/1/<?= UJIAN_TESIS_UJIAN ?>" onclick="return confirm('Apakah anda yakin ?')" class="btn btn-xs btn-success"> Terima</a>
                                                <a href="<?= base_url() ?>dosen/tesis/permintaan/tolak_bimbingan/<?= $bt['id_tesis'] ?>/<?= $bt['id_bimbingan_tesis'] ?>/1/<?= UJIAN_TESIS_UJIAN ?>" onclick="return confirm('Apakah anda yakin ?')" class="btn btn-xs btn-danger"> Tolak</a>
                                            <?php
                                            }
                                        }
                                        if($tesis->nip_pembimbing_dua == $this->session_data['username']){
                                            ...
                                            ?>
                                                ...
                                                <a href="<?= base_url() ?>dosen/tesis/permintaan/batal_bimbingan/<?= $bt['id_tesis'] ?>/<?= $bt['id_bimbingan_tesis'] ?>/2/<?= UJIAN_TESIS_UJIAN ?>" onclick="return confirm('Apakah anda yakin ?')" class="btn btn-xs btn-danger"> Batal</a>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <a href="<?= base_url() ?>dosen/tesis/permintaan/approve_bimbingan/<?= $bt['id_tesis'] ?>/<?= $bt['id_bimbingan_tesis'] ?>/2/<?= UJIAN_TESIS_UJIAN ?>" onclick="return confirm('Apakah anda yakin ?')" class="btn btn-xs btn-success"> Terima</a>
                                                <a href="<?= base_url() ?>dosen/tesis/permintaan/tolak_bimbingan/<?= $bt['id_tesis'] ?>/<?= $bt['id_bimbingan_tesis'] ?>/2/<?= UJIAN_TESIS_UJIAN ?>" onclick="return confirm('Apakah anda yakin ?')" class="btn btn-xs btn-danger"> Tolak</a>
                                            <?php
                                            }
                                        }
                                        ?>
