...
<hr>
<div class="btn-group">
    <a class="<?= ($this->uri->segment(4) == 'penguji' OR $this->uri->segment(4) == '') ? 'btn btn-default' : 'btn bg-blue'; ?>" href="<?php echo base_url() ?>dosen/tesis/ujian/penguji/<?= $id; ?>">Pengajuan</a>
    <a class="<?= ($this->uri->segment(4) == 'riwayat' OR $this->uri->segment(4) == '') ? 'btn btn-default' : 'btn bg-blue'; ?>" href="<?php echo base_url() ?>dosen/tesis/ujian/riwayat/<?= $id; ?>">Riwayat</a> 
</div>
                ...
                foreach ($tesis as $list) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {
                            ?>
                                <a href = "<?= base_url() ?>dosen/tesis/ujian/status_ujian/<?= $list['id_tesis'] ?>" class = "btn btn-xs bg-blue"><i class = "fa fa-edit"></i> Detail</a>
                            <?php
                            }
                                ...
                                if($ujian){
                                    ...
                                    if($dokumen){
                                        ...
                                        foreach ($pengujis as $penguji){
                                            if($dokumen_persetujuan){
                                                if(!empty($dokumen_persetujuan[$urut])){
