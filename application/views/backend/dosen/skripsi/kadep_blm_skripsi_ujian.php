    ...
    <div class="col-md-4">
        ...
        <div class="box-header with-border">
            ...
            <div class="pull-right">
                <a class="btn btn-xs btn-warning" href="<?= base_url()?>dashboardd/skripsi/kadep_blm_skripsi"><i class="fa fa-arrow-left"></i> Kembali</a>
            </div>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        ...
        <div class="box box-primary">
            ...
            <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?=$no?></td>
                            <td><?php if($list['status_ujian'] == '1'){ echo 'utama';}else{echo 'ulang';}?></td>
                            <td>
                            <?php 
