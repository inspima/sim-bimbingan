<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<div class="form-group">
					<label>Judul</label>
					<textarea class="form-control" name="judul" readonly><?php echo $proposal->judul?></textarea>
				</div>
				<div class="form-group">
	...
	<div class="col-md-6">
		...
		<div class="box box-primary">
			...
			<!-- /.box-header -->
			<!-- form start -->
			<?php echo form_open('dosen/sarjana/kadep/proposal/update_departemen');?>
			<div class="box-body">
				<div class="form-group">
			...
			<div class="box-footer">
				<button type="submit" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-arrow-right"></i> Pindah Departemen</button>
			</div>
			<?=form_close()?>
		</div>
		<!-- /.box -->
	...
	<div class="col-md-6">
		...
		<div class="box box-primary">
			...
			<!-- /.box-header -->
			<!-- form start -->
			<?php echo form_open('dosen/sarjana/kadep/proposal/update_proses');?>
			<div class="box-body">
				<div class="form-group">
			...
			<!-- /.box-body -->
			<div class="box-footer">
				<button type="submit" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-saved"></i> Proses</button>
			</div>
			<?=form_close()?>
		</div>
		<!-- /.box -->
