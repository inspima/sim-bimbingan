    ...
    <div class="col-md-6">
        ...
        <div class="box-header with-border">
            ...
            <div class="pull-right">
                <a class="btn btn-xs btn-warning" href="<?= base_url()?>dashboardd/proposal/kadep_ditolak"><i class="fa fa-arrow-left"></i> Kembali</a>
            </div>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
    ...
    <div class="col-md-6">
        ...
        <?php //echo form_open('dashboardd/proposal/kadep_pengajuan/update_departemen');?>
            ...
            <div class="box-footer">
                <p>Untuk pindah departemen. Kembalikan ke proses pengajuan terlebih dahulu.</p>
            </div>
        <?php //echo form_close()?>
        </div>
        <!-- /.box -->
