...
<?php endif; ?>
<div class="btn-group">
    <a class="btn btn-info" href="<?php echo base_url() ?>dosen/disertasi/permintaan/penguji">Ujian Kualifikasi</a>
    <a class="btn btn-primary" href="<?php echo base_url() ?>dosen/disertasi/permintaan/penguji/proposal">Ujian Proposal</a>
    <a class="btn btn-default" href="<?php echo base_url() ?>dosen/disertasi/permintaan/penguji/kelayakan">Ujian Kelayakan</a>
