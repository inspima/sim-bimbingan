...
<div class="btn-group">
    ...
    <a class="btn btn-default" href="<?php echo base_url() ?>dosen/disertasi/permintaan/penguji/tertutup">Ujian Tertutup</a>
                ...
                foreach ($disertasi as $list) {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php $this->view('backend/widgets/disertasi/column_penguji', ['id_disertasi' => $list['id_disertasi'], 'jenis' => 5]); ?>                            
                        </td>
                        <td class="text-center">
                            <?php $this->view('backend/widgets/disertasi/column_jadwal', ['id_disertasi' => $list['id_disertasi'], 'jenis' => 5]); ?>
                        </td>
                        <td class="text-center">
