	...
	<div class="box-body table-responsive">
		<table id="example1" class="table table-bordered table-striped">
			...
			<tr>
				...
				<th>Disertasi</th>
				<th>Tgl.Pengajuan</th>
				<th class="text-center">Penyanggah</th>
				...
				foreach ($disertasi as $list) {
					...
					<tr>
						...
						<td class="text-center">
							...
							<?php
								if ($list['status_terbuka'] == STATUS_DISERTASI_TERBUKA_DIJADWALKAN && $struktural->id_struktur == STRUKTUR_SPS) {
									?>
									<br/><br/>
									...
									<button class="btn btn-xs btn-success"><i class="fa fa-check"></i> Proses Setujui
									</button>
									<?php echo form_close() ?>
									<?php
								...
								if ($list['status_terbuka'] >= STATUS_DISERTASI_TERBUKA_DIJADWALKAN && ($struktural->id_struktur == STRUKTUR_SPS || $struktural->id_struktur == STRUKTUR_KPS_S3)) {
									?>
