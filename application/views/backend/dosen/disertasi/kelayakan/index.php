                ...
                foreach ($disertasi as $list) {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <?php
                            if ($list['status_kelayakan'] == 1 && $struktural->id_struktur == STRUKTUR_SPS) {
                                ?>
                                <br/><br/>
                                ...
                                <?php echo form_close() ?>
                                <?php
                            } else if ($list['status_kelayakan'] == 2 && $struktural->id_struktur == STRUKTUR_KPS_S3) {
                                ?>
                                <br/><br/>
                                <?php echo form_open('dosen/disertasi/kelayakan/terima') ?>
                                <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                                ...
                                <?php echo form_close() ?>
                                <?php
                            } else if ($list['status_kelayakan'] >= 4 && $struktural->id_struktur == STRUKTUR_KPS_S3) {
                                ?>
                                <br/><br/>
