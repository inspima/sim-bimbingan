...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open('dosen/disertasi/kelayakan/jadwal_save'); ?>
            <div class="box-body">
...
<div class="row">
                        ...
                        <table class="table table-bordered">
                            ...
                            foreach ($penguji as $listpenguji) {
                                ...
                                <tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        <?php echo form_open('dosen/disertasi/kelayakan/penguji_update_statustim') ?>
                                                        <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                                                        <?php echo formtext('hidden', 'id_disertasi', $disertasi->id_disertasi, 'required') ?>
                                                        <?php echo formtext('hidden', 'id_ujian', $id_ujian, 'required') ?>
                                    ...
                                    <td>
                                        <?php echo form_open('dosen/disertasi/kelayakan/penguji_delete') ?>
                                        <?php echo formtext('hidden', 'hand', 'center19', 'required') ?>
                                        <?php echo formtext('hidden', 'id_disertasi', $disertasi->id_disertasi, 'required') ?>
                                        <?php echo formtext('hidden', 'id_ujian', $id_ujian, 'required') ?>
                                        <?php echo formtext('hidden', 'id_penguji', $listpenguji['id_penguji'], 'required') ?>
    ...
    <div class="col-md-6">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open('dosen/disertasi/kelayakan/update_status_ujian'); ?>
                ...
                <div class="form-group">
                    ...
                    <select name="status_ujian" class="form-control select2" style="width: 100%;" required>
                        ...
                        foreach ($status_ujians as $status_ujian) {
                            ?>
                            <option value="<?php echo $status_ujian['value'] ?>" <?php if ($status_ujian['value'] == $disertasi->status_ujian_kelayakan) echo 'selected' ?>><?php echo $status_ujian['text'] ?></option>
                            <?php
                        }
                        ?>
                    </select>
