...
<?php endif; ?>
<div class="btn-group">
	<a class="<?= ($this->uri->segment(4) == '') ? 'btn btn-default' : 'btn bg-blue'; ?>" href="<?php echo base_url() ?>dosen/dokumen/undangan"><i class="fa fa-check-circle-o"></i> Permintaan</a>
	<a class="<?= ($this->uri->segment(4) == 'riwayat') ? 'btn btn-default' : 'btn bg-yellow'; ?>" href="<?php echo base_url() ?>dosen/dokumen/undangan/riwayat"><i class="fa fa-history"></i> Riwayat</a>
</div>
