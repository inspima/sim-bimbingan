...
<html lang="en">
    ...
    <body>
        ...
        <p align="center">
            <u><h2>PRESENSI UJIAN TESIS</h2></u>
        </p>
                ...
                <td>
                    <table border="0" style="width:100%">
                        ...
                        <tr valign="top">
                            <td>Acara</td>
                            <td>:</td>
                            <td>Ujian Tesis Program Magister <?php echo ucwords(strtolower($tesis->nm_prodi));?> a.n. <?php echo $tesis->nama ?> / NIM. <?php echo $tesis->nim ?> </td>
                        </tr>
                        <?php
                        }
                        ?>
