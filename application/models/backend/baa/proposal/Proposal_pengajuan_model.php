...
class Proposal_pengajuan_model extends CI_Model {

	public function read()
	{
		$this->db->select('s.id_skripsi, s.tgl_pengajuan, s.judul, s.berkas_proposal, ,s.keterangan_proposal, dn.departemen, g.gelombang, sr.semester, m.nim, m.nama ');
