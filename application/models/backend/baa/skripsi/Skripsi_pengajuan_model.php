...
class Skripsi_pengajuan_model extends CI_Model {

	public function read()
	{
		$this->db->select('s.id_skripsi, s.tgl_pengajuan, s.turnitin, s.toefl, dn.departemen, m.nim, m.nama ');
        ...
        $this->db->where('s.status_skripsi',1);
