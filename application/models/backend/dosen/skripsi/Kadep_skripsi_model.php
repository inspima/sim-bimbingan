...
class Kadep_skripsi_model extends CI_Model {

	public function read($id_departemen)
	{   
        //$stts = array('3','4','5');
		$this->db->select('u.id_ujian, u.id_skripsi, u.status_ujian, u.tanggal, r.ruang, r.gedung, j.jam, m.nim, m.nama, s.status_skripsi, g.gelombang, sr.semester, d.departemen, s.turnitin, s.nilai');
        ...
        $this->db->where('s.status_skripsi',4);
