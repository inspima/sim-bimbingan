<?php if (!defined('BASEPATH')) {
	...
	class Kadep_selesai_model extends CI_Model
	{

		public function read($id_departemen)
		{
			$status_ujians = ['1', '2'];
			$this->db->select('s.id_skripsi, s.tgl_pengajuan, s.judul, s.berkas_proposal, s.status_ujian_proposal,s.keterangan_proposal, dn.departemen, sr.semester, m.nim, m.nama ');
