...
class ProposalTesis_model extends CI_Model {
    ...
    {
        $this->db->insert('judul_tesis', $dataj);
    }
    ...
    function ujian($id, $username) //belum update
    {
        $stts = array('2','3');
    ...
    public function read_penguji($id_ujian) //belum update
    {
        $stts = array('1','2');
