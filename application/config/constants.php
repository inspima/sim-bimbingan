...
‎');
	...
	// JENIS DOKUMEN
	/// S1
	define('DOKUMEN_JENIS_SKRIPSI_UJIAN_PROPOSAL_STR', 's1_proposal');
	define('DOKUMEN_JENIS_SKRIPSI_UJIAN_SKRIPSI_STR', 'skripsi');
	// S2
	define('DOKUMEN_JENIS_TESIS_UJIAN_PROPOSAL_STR', 's2_proposal');
	define('DOKUMEN_JENIS_TESIS_UJIAN_SKRIPSI_STR', 'tesis');
	// S3
	define('DOKUMEN_JENIS_DISERTASI_UJIAN_KUALIFIKASI_STR', 'kualifikasi');
	define('DOKUMEN_JENIS_DISERTASI_UJIAN_PROPOSAL_STR', 's3_proposal');
	...
	define('TAHAPAN_TESIS_PROPOSAL_STR', 'proposal');
	define('TAHAPAN_TESIS_UJIAN_STR', 'ujian');
	...
	define('STATUS_DISERTASI_PROPOSAL_SELESAI', 9);
