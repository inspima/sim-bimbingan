...
');
	...
	define('TAHAPAN_SKRIPSI_PROPOSAL_STR', 'skripsi_proposal');
	define('TAHAPAN_SKRIPSI_UJIAN_STR', 'skripsi');
	...
	define('STATUS_DISERTASI_KUALIFIKASI_SETUJUI_PENGUJI', 6);
	define('STATUS_DISERTASI_KUALIFIKASI_CETAK_DOKUMEN', 7);
	define('STATUS_DISERTASI_KUALIFIKASI_UJIAN', 8);
	...
	define('STATUS_DISERTASI_PROPOSAL_CETAK_DOKUMEN', 8);
	define('STATUS_DISERTASI_PROPOSAL_UJIAN', 9);
	...
	define('STATUS_DISERTASI_KELAYAKAN_CETAK_DOKUMEN', 7);
	define('STATUS_DISERTASI_KELAYAKAN_UJIAN', 8);
	...
	define('STATUS_DISERTASI_TERTUTUP_CETAK_DOKUMEN', 7);
	define('STATUS_DISERTASI_TERTUTUP_UJIAN', 8);
	define('STATUS_DISERTASI_TERTUTUP_SELESAI', 9);

	// STATUS TAHAPAN PROSES UJIAN TERBUKA
	define('STATUS_DISERTASI_TERBUKA_PENGAJUAN', 1);
	define('STATUS_DISERTASI_TERBUKA_SETUJUI_UP4I', 2);
	define('STATUS_DISERTASI_TERBUKA_SETUJUI_ADMIN_PRODI', 3);
	define('STATUS_DISERTASI_TERBUKA_SETUJUI_PROMOTOR', 4);
	define('STATUS_DISERTASI_TERBUKA_DIJADWALKAN', 5);
	define('STATUS_DISERTASI_TERBUKA_SETUJUI_SPS', 6);
	define('STATUS_DISERTASI_TERBUKA_SETUJUI_KPS', 7);
