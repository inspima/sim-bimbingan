<?php
	...
	define('TAHAPAN_TESIS_PROPOSAL', 1);
	define('TAHAPAN_TESIS_UJIAN', 2);
	...
	define('UJIAN_TESIS_UJIAN', 2);

	// STATUS TAHAPAN PROSES TESIS PROPOSAL
	// PRODI S2 ILMU HUKUM
	define('MIH_STATUS_TESIS_PROPOSAL_PENGAJUAN', 1);
	define('MIH_STATUS_TESIS_PROPOSAL_SETUJUI_SPS', 2); 
	define('MIH_STATUS_TESIS_PROPOSAL_SETUJUI_KEBAG', 3); 
	define('MIH_STATUS_TESIS_PROPOSAL_DIJADWALKAN_KPS', 4);
	define('MIH_STATUS_TESIS_PROPOSAL_SETUJUI_PENGUJI', 5);
	define('MIH_STATUS_TESIS_PROPOSAL_UJIAN', 6);
	define('MIH_STATUS_TESIS_PROPOSAL_UJIAN_SELESAI', 7);
	define('MIH_STATUS_TESIS_PROPOSAL_TOLAK_SPS', 8); 
	define('MIH_STATUS_TESIS_PROPOSAL_TOLAK_KEBAG', 9); 

	// PRODI S2 KENOTARIATAN
	define('MKN_STATUS_TESIS_PROPOSAL_PENGAJUAN_JUDUL', 1);
	define('MKN_STATUS_TESIS_PROPOSAL_SETUJUI_SPS', 2); 
	define('MKN_STATUS_TESIS_PROPOSAL_KAPRODI_PILIH_PEMBIMBING', 3); 
	define('MKN_STATUS_TESIS_PROPOSAL_PENGAJUAN_UJIAN', 4);
	define('MKN_STATUS_TESIS_PROPOSAL_SETUJUI_BAA', 5);
	define('MKN_STATUS_TESIS_PROPOSAL_DIJADWALKAN_KPS', 6);
	define('MKN_STATUS_TESIS_PROPOSAL_SETUJUI_PENGUJI', 7);
	define('MKN_STATUS_TESIS_PROPOSAL_UJIAN', 8);
	define('MKN_STATUS_TESIS_PROPOSAL_UJIAN_SELESAI', 9);
	define('MKN_STATUS_TESIS_PROPOSAL_TOLAK_SPS', 10); 
	define('MKN_STATUS_TESIS_PROPOSAL_TOLAK_BAA', 11); 

	define('STATUS_TESIS_PROPOSAL_PENGAJUAN', 1);
	define('STATUS_TESIS_PROPOSAL_SETUJUI_SPS', 2); 
	define('STATUS_TESIS_PROPOSAL_DIJADWALKAN_KPS', 3);
	define('STATUS_TESIS_PROPOSAL_SETUJUI_PENGUJI', 4);
	define('STATUS_TESIS_PROPOSAL_UJIAN', 5);
	define('STATUS_TESIS_PROPOSAL_UJIAN_SELESAI', 6);

	//define('STATUS_TESIS_PROPOSAL_SELESAI', 7);
	// STATUS TAHAPAN PROSES TESIS UJIAN
	define('STATUS_TESIS_UJIAN_PENGAJUAN', 1);
	define('STATUS_TESIS_UJIAN_SETUJUI_BAA', 2);
	define('STATUS_TESIS_UJIAN_DIJADWALKAN_KPS', 3);
	...
	define('STATUS_DISERTASI_KUALIFIKASI_DIJADWALKAN', 2);
	define('STATUS_DISERTASI_KUALIFIKASI_SETUJUI_PENGUJI', 3);
	define('STATUS_DISERTASI_KUALIFIKASI_SETUJUI_SPS', 4);
	define('STATUS_DISERTASI_KUALIFIKASI_SETUJUI_KPS', 5);
	define('STATUS_DISERTASI_KUALIFIKASI_UJIAN', 6);
	define('STATUS_DISERTASI_KUALIFIKASI_CETAK_DOKUMEN', 7);
	define('STATUS_DISERTASI_KUALIFIKASI_SELESAI', 8);

	// STATUS TAHAPAN PROSES PENGAJUAN PROMOTOR
	define('STATUS_DISERTASI_PROMOTOR_PENGAJUAN', 1);
	define('STATUS_DISERTASI_PROMOTOR_SETUJUI_KPS', 2);
	define('STATUS_DISERTASI_PROMOTOR_SETUJUI', 3);
	define('STATUS_DISERTASI_PROMOTOR_SELESAI', 4);

	// STATUS TAHAPAN PROSES MPKK
	define('STATUS_DISERTASI_MPKK_PENGAJUAN', 1);
	define('STATUS_DISERTASI_MPKK_SETUJUI_KPS', 2);
	define('STATUS_DISERTASI_MPKK_SETUJUI_PROMOTOR', 3);
	define('STATUS_DISERTASI_MPKK_PENILAIAN', 4);
	define('STATUS_DISERTASI_MPKK_SELESAI', 5);

	// STATUS TAHAPAN PROSES UJIAN PROPOSAL
	define('STATUS_DISERTASI_PROPOSAL_PENGAJUAN', 1);
	define('STATUS_DISERTASI_PROPOSAL_SETUJUI_BAA', 2);
	...
	define('STATUS_DISERTASI_MKPD_SETUJUI_KPS', 2);
	define('STATUS_DISERTASI_MKPD_SETUJUI_PROMOTOR', 3);
	define('STATUS_DISERTASI_MKPD_PENILAIAN', 4);
