<?php
	...
	define('TAHAPAN_TESIS_JUDUL_PROPOSAL', 1);
	...
	define('STATUS_TESIS_JUDUL_PROPOSAL_PENGAJUAN', 1);
	define('STATUS_TESIS_JUDUL_PROPOSAL_SETUJUI_SPS', 2); 
	define('STATUS_TESIS_JUDUL_PROPOSAL_SETUJUI_PEMBIMBING', 3);

	// STATUS TAHAPAN PROSES TESIS PROPOSAL
	define('STATUS_TESIS_PROPOSAL_PENGAJUAN', 1);
	define('STATUS_TESIS_PROPOSAL_DIJADWALKAN_PEMBIMBING_UTAMA', 2);
	...
	define('STATUS_TESIS_MKPT_DIJADWALKAN_KPS', 3);
	define('STATUS_TESIS_MKPT_SETUJUI_PENGUJI', 4);
	define('STATUS_TESIS_MKPT_UJIAN', 5);
	define('STATUS_TESIS_MKPT_UJIAN_SELESAI', 6);
